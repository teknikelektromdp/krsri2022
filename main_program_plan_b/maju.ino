...
void MajuAwalKiri(){
  ServoMovementDouble("LFT", majuDorong, "RBT", majuDorong);
  delay(1);
}

//gabungan prosedur maju awalan kanan
...
//gabungan prosedur maju awalan kiri
void MajuGerakKiri(int tinggiAngkat){
  MajuKiri(tinggiAngkat);
  MajuKiriDorong();
  MajuKanan(tinggiAngkat);
  MajuKananDorong();
